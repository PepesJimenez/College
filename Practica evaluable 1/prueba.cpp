...
*/
    ...
    */
    ...
    bool UsuarioTwitter::me_sigue(const std::string &otro_usuario) const{
        ...
        //Buscamos al usuario en la lista de seguidores
        for (unsigned i = 0; i < seguidores.num_usuarios; i++){

            if (seguidores.listado[i] == otro_usuario){

                //Usuario encontrado
                encontrado = true;

                //Salida del bucle
                i = seguidores.num_usuarios;

            }   // No hace falta else al ser encontrado = false por defecto
        }
    ...
    bool UsuarioTwitter::estoy_siguiendo(const std::string &otro_usuario) const{
        ...
        //Buscamos al usuario en la lista de siguiendo
        for (unsigned i = 0; i < siguiendo.num_usuarios; i++){

            if (siguiendo.listado[i] == otro_usuario){

                //Usuario encontrado
                encontrado = true;

                //Salida del bucle
                i = siguiendo.num_usuarios;
